...
import com.codeflix.admin.catalogo.configuration.json.Json;
...
public class CategoryE2ETest {
    ...
    private GetCategoryResponse retrieveACategory(final String anId) throws Exception {
        ...
        return Json.readValue(json, GetCategoryResponse.class);
    }
}